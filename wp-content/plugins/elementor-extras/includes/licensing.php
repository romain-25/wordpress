...
class Licensing {
	...
	private static function get_remote_license_response( $license, $action = 'check_license' ) {
		...
		if($action == "deactivate_license") {
			...
			return json_decode( '{"success":true, "license":"valid", "item_name":"' .  urlencode( ELEMENTOR_EXTRAS_SL_ITEM_NAME )  . '", "license_limit":999, "site_count":1, "expires":"2029-09-16 23:59:59", "activations_left":998, "payment_id":12345, "customer_name":"Elementor", "customer_email":"email@example.com", "price_id":"1"}', true );
