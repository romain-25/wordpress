...
function lae_get_grid_classes($settings, $columns_field = 'per_line') {
    ...
    return apply_filters('lae_grid_classes', $grid_classes, $settings, $columns_field);
}
...
function lae_get_option($option_name, $default = null) {
    ...
    return apply_filters('lae_get_option', $option_value, $option_name, $default);
}
...
function lae_get_image_html($image_setting, $image_size_key, $settings) {
    ...
    if (!empty($attachment_id) && in_array($size, $image_sizes)) {
        ...
        if (!empty($image_src)) {
            ...
            $image_html .= sprintf('<img src="%s" title="%s" alt="%s"%s />', esc_attr($image_src), get_the_title($attachment_id), lae_get_image_alt($attachment_id), $image_class_html);
        }
    }

    return apply_filters('lae_attachment_image_html', $image_html, $image_setting, $image_size_key, $settings);
}
...
function lae_get_taxonomy_terms_filter($taxonomies, $chosen_terms = array()) {
    ...
    return apply_filters('lae_taxonomy_terms_filter', $output, $taxonomies, $chosen_terms);
}
...
function lae_get_animation_options() {
    ...
    if (lae_fs()->can_use_premium_code__premium_only()) {
        return apply_filters('lae_animation_options', array(
            ...
            'bounce' => __('Bounce', 'livemesh-el-addons'),
            'flash' => __('Flash', 'livemesh-el-addons'),
            'pulse' => __('Pulse', 'livemesh-el-addons'),
            'swing' => __('Swing', 'livemesh-el-addons'),
            'shake' => __('Shake', 'livemesh-el-addons'),
            'tada' => __('Tada', 'livemesh-el-addons'),
            'wobble' => __('Wobble', 'livemesh-el-addons'),
            'jello' => __('Jello', 'livemesh-el-addons'),
            'rubberBand' => __('Rubber Band', 'livemesh-el-addons'),
            'bounceIn' => __('Bounce In', 'livemesh-el-addons'),
            'bounceInLeft' => __('Bounce In Left', 'livemesh-el-addons'),
            'bounceInRight' => __('Bounce In Right', 'livemesh-el-addons'),
            'bounceInDown' => __('Bounce In Down', 'livemesh-el-addons'),
            'bounceInUp' => __('Bounce In Up', 'livemesh-el-addons'),
            'fadeIn' => __('Fade In', 'livemesh-el-addons'),
            'fadeInLeft' => __('Fade In Left', 'livemesh-el-addons'),
            'fadeInLeftBig' => __('Fade In Left Big', 'livemesh-el-addons'),
            'fadeInRight' => __('Fade In Right', 'livemesh-el-addons'),
            'fadeInRightBig' => __('Fade In Right Big', 'livemesh-el-addons'),
            'fadeInUp' => __('Fade In Up', 'livemesh-el-addons'),
            'fadeInUpBig' => __('Fade In Up Big', 'livemesh-el-addons'),
            'fadeInDown' => __('Fade In Down', 'livemesh-el-addons'),
            'fadeInDownBig' => __('Fade In Down Big', 'livemesh-el-addons'),
            'flip' => __('Flip', 'livemesh-el-addons'),
            'flipInX' => __('Flip In X', 'livemesh-el-addons'),
            'flipInY' => __('Flip In Y', 'livemesh-el-addons'),
            'lightSpeedIn' => __('Light Speed In', 'livemesh-el-addons'),
            'rotateIn' => __('Rotate In', 'livemesh-el-addons'),
            'rotateInUpLeft' => __('Rotate In Up Left', 'livemesh-el-addons'),
            'rotateInUpRight' => __('Rotate In Up Right', 'livemesh-el-addons'),
            'rotateInDownLeft' => __('Rotate In Down Left', 'livemesh-el-addons'),
            'rotateInDownRight' => __('Rotate In Down Right', 'livemesh-el-addons'),
            'slideInLeft' => __('Slide In Left', 'livemesh-el-addons'),
            'slideInRight' => __('Slide In Right', 'livemesh-el-addons'),
            'slideInDown' => __('Slide In Down', 'livemesh-el-addons'),
            'slideInUp' => __('Slide In Up', 'livemesh-el-addons'),
            'zoomIn' => __('Zoom In', 'livemesh-el-addons'),
            'zoomInLeft' => __('Zoom In Left', 'livemesh-el-addons'),
            'zoomInRight' => __('Zoom In Right', 'livemesh-el-addons'),
            'zoomInDown' => __('Zoom In Down', 'livemesh-el-addons'),
            'zoomInUp' => __('Zoom In Up', 'livemesh-el-addons'),
            'rollIn' => __('Roll In', 'livemesh-el-addons'),
        ));
    }
    else {
        return apply_filters('lae_animation_options', array(
