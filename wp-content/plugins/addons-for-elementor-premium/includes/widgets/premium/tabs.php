...
class LAE_Tabs_Widget extends Widget_Base {
    ...
    protected function render() {
        ...
        foreach ($settings['tabs'] as $tab) :
            ...
            $tab_elements[] = apply_filters('lae_tab_nav_output', $tab_nav, $tab, $settings);

            $tab_panes[] = apply_filters('lae_tab_content_output', $tab_content, $tab, $settings);

        endforeach;

        $output = '<div class="lae-tabs ' . $vertical_class . ' ' . esc_attr($settings['style'])
            . '" data-mobile-width="' . intval($settings['mobile_width']) . '">';

        $output .= '<a href="#" class="lae-tab-mobile-menu"><i class="lae-icon-menu"></i>&nbsp;</a>';

        $output .= '<div class="lae-tab-nav">';
        ...
        $output .= '</div><!-- .lae-tab-nav -->';

        $output .= '<div class="lae-tab-panes">';
        ...
        $output .= '</div><!-- .lae-tab-panes -->';

        $output .= '</div><!-- .lae-tabs -->';

        echo apply_filters('lae_tabs_output', $output, $settings);
