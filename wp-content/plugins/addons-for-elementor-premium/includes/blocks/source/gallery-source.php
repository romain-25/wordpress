    ...
    function get_media($size = 'default') {
        ...
        if ($this->is_video_item()):
            ...
            if (isset($this->item['item_image']) && !empty($this->item['item_image']['id'])):
                ...
                $image_html = lae_get_image_html($this->item['item_image'], 'thumbnail_size', $this->settings);
            ...
            elseif ($this->item_type == 'youtube' || $this->item_type == 'vimeo') :
                ...
                if (!empty($thumbnail_url)):
                    ...
                    $image_html = sprintf('<img src="%s" title="%s" alt="%s" class="lae-image"/>', esc_attr($thumbnail_url), esc_html($this->item['item_name']), esc_html($this->item['item_name']));
