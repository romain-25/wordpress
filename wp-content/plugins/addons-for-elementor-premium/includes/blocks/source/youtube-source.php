...
class LAE_YouTube_Grid_Source extends LAE_Source {
    ...
    public function get_thumbnail($size = 'default') {
        ...
        return apply_filters('lae_youtube_post_thumbnail', $output, $size, $this);
    }
    ...
    public function get_media($size = 'default') {
        ...
        if (isset($this->item['image']) && !empty($this->item['image']['url'])):
            ...
            $image_html = sprintf('<img src="%s" title="%s" alt="%s" class="lae-image"/>', esc_attr($this->item['image']['url']), esc_html($this->item['image']['alt']), esc_html($this->item['image']['alt']));

        endif;

        $output .= apply_filters('lae_youtube_post_thumbnail_html', $image_html, $this->item, $this->settings);


        return apply_filters('lae_youtube_post_media', $output, $size, $this);
    }
    ...
    public function get_media_overlay() {
        ...
        return apply_filters('lae_youtube_post_media_overlay', $output, $this);
    ...
    public function get_video_lightbox() {
        ...
        return apply_filters('lae_youtube_post_video_lightbox_html', $output, $this);
    }
    ...
    function get_entry_title() {
        ...
        return apply_filters('lae_youtube_entry_title', $output, $this->item, $this->settings);
    ...
    function get_thumbnail_title() {
        ...
        return apply_filters('lae_youtube_thumbnail_title', $output, $this->item, $this->settings);

    }

    function get_title() {

        $output = '<' . $this->settings['item_title_tag'] . ' class="lae-entry-title">';
        ...
        $output .= '</' . $this->settings['item_title_tag'] . '>';


        return apply_filters('lae_youtube_post_title', $output, $this->item, $this->settings);
    ...
    public function get_excerpt() {
        ...
        return apply_filters('lae_youtube_post_text', $output, $this);
    ...
    public function get_views() {
        ...
        return apply_filters('lae_youtube_post_views', $output, $this);
    ...
    public function get_duration() {
        ...
        return apply_filters('lae_youtube_post_duration', $output, $this);
    ...
    public function get_likes() {
        ...
        if ($this->settings['display_likes']) :
            ...
            $output .= '<i class="lae-icon-like"></i>';
        ...
        return apply_filters('lae_youtube_post_likes', $output, $this);
    ...
    public function get_channel() {
        ...
        if ($this->settings['display_channel']) :

            $output .= '<a class="lae-youtube-channel" href="' . esc_url($this->item['author']['url']) . '" title="' . esc_attr($this->item['author']['name']) . '">';
        ...
        return apply_filters('lae_youtube_post_author', $output, $this);
    }
    ...
    public function get_date() {
        ...
        return apply_filters('lae_youtube_post_date', $output, $this);
    }
    ...
    public function get_comments_number() {
        ...
        return apply_filters('lae_youtube_post_comments', $output, $this);
    ...
    function get_categories() {
        ...
        // no concept of categories in YouTube and tags can be too many and too big to display in our grid
        return '';
    }
}