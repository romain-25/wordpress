  ...
  $skin->add_control(
    ...
    $skin->add_control(
        ...
        'return_value' => '100%',
				'default' => 'auto',
				'selectors' => [
					' {{WRAPPER}} article .elementor, {{WRAPPER}} article .elementor .elementor-inner, {{WRAPPER}} article .elementor .elementor-inner .elementor-section-wrap, {{WRAPPER}} article .elementor .elementor-inner .elementor-section-wrap .elementor-top-section, {{WRAPPER}} article .elementor .elementor-container'
              => 'height: {{VALUE}} ',
