...
class Mailchimp extends Widget_Base {
	...
	public function get_script_depends() {
		return [ 'bdt-uikit-icons', 'ep-mailchimp' ];
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bdt-newsletter-btn .bdt-flex-align-right'  => 'margin-left: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .bdt-newsletter-btn .bdt-flex-align-left'   => 'margin-right: {{SIZE}}{{UNIT}};',
