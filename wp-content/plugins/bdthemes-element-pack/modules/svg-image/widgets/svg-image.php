...
class Svg_Image extends Widget_Base {
	...
	protected function render() {
		...
		$parallax_stroke   = 100 - $settings['parallax_effects_stroke_value']['size'];
		$parallax_viewport = $settings['parallax_effects_viewport_value']['size'];
