    ...
    protected function _register_controls()
    {
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .bdt-fancy-list  .custom-list-group li',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '#595959',
                'selectors' => [
                    '{{WRAPPER}} .bdt-fancy-list .list-text h4 ' => 'color: {{VALUE}} ',
                ],
            ]
        );
        ...
        $this->add_control(
            'des_text_color',
            [
                'label' => __('Subtitle Color', 'bdthemes-element-pack'),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
        ...
        $this->add_control(
            'text_indent',
            [
                'label' => __('Title Indent', 'bdthemes-element-pack'),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'max' => 50,
                ...
                'selectors' => [
                    '{{WRAPPER}} .bdt-fancy-list .list-text h4,{{WRAPPER}} .bdt-fancy-list  .list-text-des ' => is_rtl() ? 'padding-right: {{SIZE}}{{UNIT}};' : 'padding-left: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .bdt-fancy-list .list-text h4,{{WRAPPER}} .bdt-fancy-list  .list-text-des ',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '#724DEB',
                'selectors' => [
                    '{{WRAPPER}} .bdt-fancy-list .custom-list-group a:hover .list-text h4' => 'color: {{VALUE}}',
                ],
            ]
        );
