 ...
 * Description: Element Pack is a packed of elementor widgets. This plugin gives you extra widgets features for elementor page builder plugin.
 * Version: 4.3.0
 * Author: BdThemes
 ...
 * License: GPL3
 * Elementor requires at least: 2.7.0
 * Elementor tested up to: 2.8.2
 */

// Some pre define value for easy use
define( 'BDTEP_VER', '4.3.0' );
...
update_option( 'element_pack_license_key', 'xxxxxxxx-xxxxxxxx-xxxxxxxx-xxxxxxxx' );
update_option( 'element_pack_license_email', 'valid@mail.com' );
